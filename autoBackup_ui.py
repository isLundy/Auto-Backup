...
class AutoBackup:
    ...
    def start_timing(self):
        ...
        if self.backup_user()['enabled']:
            self.scheduler.enter(self.backup_user()['timer']*0.25, 1, self.copy_to_backup_dir)
...
class AutoBackup_UI(QWidget):
    ...
    def set_ui(self):
        ...
        self.backup_dir_display_label.setDisabled(True)
    ...
    def set_window(self):
        ...
        self.resize(self.total_size.width()*1.3, self.total_size.height())
